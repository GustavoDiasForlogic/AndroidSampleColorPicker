...
public class CustomColorPickerDialog extends AlertDialog {
    ...
    public CustomColorPickerDialog(Context context, int initialColor, final OnColorSelectedListener listener) {
        super(context);
        ...
        lp = new RelativeLayout.LayoutParams( FrameLayout.LayoutParams.MATCH_PARENT, selectedColorHeight + 2 * borderSize );
        lp.bottomMargin = (int) (context.getResources().getDisplayMetrics().density * CONTROL_SPACING_DP);
        ...
        lp = new RelativeLayout.LayoutParams( RelativeLayout.LayoutParams.MATCH_PARENT, selectedColorHeight + 2 * borderSize );
    ...
    private static class ColorWheel  extends View {
    ...
    private static class ValueSlider extends View {
        ...
        public ValueSlider(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
        }
